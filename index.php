            ...
            <div class="col-md-12">
                <div class="banner-content">
                    <div class="banner-carousel owl-carousel owl-theme">
                        <div class="item">
                            <img src="images\bannerimg-3.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="images\bannerimg-2.jpg" alt="">
                        </div>
                        <div class="item">
                            <img src="images\bannerimg-1.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    <div class="product-grid latest item">
                        ...
                        <div class="product-content">
                            <h3 class="title">
                                <a href="single_product.php?pid=<?php echo $row['product_id']; ?>"></a>
                            </h3>
                            <div class="price"><?php echo $cur_format; ?> <?php echo $row['product_price']; ?></div>
                        </div>
                    </div>
