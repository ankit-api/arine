                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    $product_images = array_filter(explode(',',$row[$i]['product_images']));
                                        // echo "<script>console.log(".json_encode($product_qty).")</script>";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span><b>Delivery Expected By :</b> <?php echo date('d',strtotime($row[$i]['order_date']. ' +4 day')); ?> - <?php echo date('d M, Y',strtotime($row[$i]['order_date']. ' +7 day')); ?></span>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                    <tr>
